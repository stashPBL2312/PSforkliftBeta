// Safe per-row mapping: update archive_maintenance_jobs using job id and original old forklift_id
const fs = require('fs');
...
async function run(){
  ...
  let updated = 0, unmapped = 0; const errors = [];
  ...
  console.log(`Safe mapping selesai. Rows updated: ${updated}, Unmapped jobs: ${unmapped}, Errors: ${errors.length}`);
